...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes, threshold=0, dataset='coco'):
        ...
        out_interaction_logits = outputs['pred_interactiveness']
        ...
        # TODO
        interaction_prob = F.softmax(out_interaction_logits,-1)
        interaction_scores, _ = interaction_prob[..., :-1].max(-1)
        interaction_scores  = torch.exp(interaction_scores)
