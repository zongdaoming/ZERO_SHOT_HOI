...
def setup_cfg(args):
    ...
    cfg.MODEL.ROI_HEADS.HOI_SCORE_THRESH_TEST = args.confidence_threshold
    # Set novel objects
    cfg.ZERO_SHOT.NOVEL_CLASSES += args.novel_object if args.novel_object else []
    cfg.freeze()
    return cfg
...
def get_parser():
    ...
    parser.add_argument(
        "--novel-object",
        nargs="+",
        help="A list of interested novel object categories",
    )
    return parser
