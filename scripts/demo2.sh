...
# Run demo to discover human interactions with novel (zero-shot) objects. 
# Please incidate the interested novel objects (categories out of 80 MS-COCO objects) via command line arguments.


# sh ./scripts/demo.sh test 1 ./configs/HICO-DET/interaction_zero_shot_R_50_FPN.yaml
